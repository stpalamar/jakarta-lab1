...
@WebServlet(name = "danyloServlet", value = "/danylo")
public class DanyloServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<title>Danylo Melnyk</title>");
        out.println("<link rel=\"stylesheet\" href=\"css/styles.css\">");
        out.println("</head>");
        out.println("<body>");
        out.println("<h1>Danylo Melnyk</h1>");
